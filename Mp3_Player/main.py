...
def next_song():
    ...
    if song_list_not_empty:
        try:
            ...
            tkinter.messagebox.showerror(title="Error", message="That was a last song. No more songs after currrent one.")
            button1.config(borderwidth=0)
    else:
...
def previous_song():
    ...
    if song_list_not_empty:
        try:
            ...
            tkinter.messagebox.showerror(title="Error", message="That was a first song. No more songs before currrent one.")
    else:
        tkinter.messagebox.showerror(title="Error", message="No songs on the list.")
