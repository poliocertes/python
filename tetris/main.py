...
blocks_colors = [BLUE, GREEN, RED, YELLOW, ORANGE, BLACK, PINK]
score = 0
...
def main():
    ...
    while running:
        ...
        show_next = pg.font.Font.render(pg.font.SysFont('Arial', 30), 'Next element', True, (255, 255, 255))
